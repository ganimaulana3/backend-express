...
router.post('/', asyncHandler(async (req, res) => {
    try {
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            let imageUrl = 'no_url';
            if (req.file) {
                imageUrl = `https://backend-lapak-siswa.up.railway.app/image/poster/${req.file.filename}`;
            }
...
router.put('/:id', asyncHandler(async (req, res) => {
    try {
        ...
        uploadPosters.single('img')(req, res, async function (err) {
            ...
            if (req.file) {
                image = `https://backend-lapak-siswa.up.railway.app/image/poster/${req.file.filename}`;
            }
